...
{{<image-with-caption/start src="5.png" alt="All the age-friendly events we knew about in Hulme and Moss Side this time last year…" classList="image--frame">}}
...
{{<image-with-caption/start src="6.png" alt="Internet use stats showing a huge drop-off for over 70s" classList="image--frame">}}
...
{{<image-with-caption/start src="7.png" alt="Differences in walking speed based on education and age" classList="image--frame">}}
...
{{<image-with-caption/start src="19.png" alt="Oh yeah — and we had a photobooth!" classList="image--center">}}
